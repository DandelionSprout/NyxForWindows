...
* 28 November 2025: Nyx for Windows does not work on Python 3.14 or on any currently known ARM64 Python versions, due to `windows-curses` not having been listed on PyPi as supporting Python 3.14, and that it is unclear if any alternate dependencies out there would work. It remains functional on Python 3.13.
