...
* 28 November 2025: Nyx for Windows does not work on Python 3.14, due to `windows-curses` not having been listed on PyPi as supporting Python 3.14, and that it is unclear if any alternate dependencies out there would work. It remainings functional on Python 3.13.
